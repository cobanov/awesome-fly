...
- [train-your-fly / connectome](https://github.com/eudald-seeslab/train-your-fly) by **eudald-seeslab** - Training toolkit for connectome-constrained models, from a *Drosophila* eye model through message passing over FlyWire v783 to a Kenyon-cell readout. The [connectome](https://github.com/eudald-seeslab/connectome) study adds colour, shape, and numerosity tasks, constrained randomized ensembles, and manifold analysis.
