...
- [Fly Megacode](https://github.com/Jimmy110101013/fly-megacode) by **Jimmy110101013** - Browser experiment where a FlyWire FAFB v783 mushroom body learns the AHA 2025 ACLS cardiac-arrest algorithm from a one-bit dopamine signal, over a live skeleton atlas of the cells deciding. **Extracted circuit; only KC→MBON is plastic:** a 2,875-neuron central complex runs as a fixed, untrained reservoir holding the resuscitation history the model is no longer shown. Reports the matching ablation (76.8% with the reservoir, 17.6% without, 11.8% chance, 3 seeds on unseen scenarios) and retracts two earlier scores that were grader artifacts. A neuroscience experiment, not a clinical or ACLS training tool. [Play](https://jimmy110101013.github.io/fly-megacode/) · [Methods and results](https://github.com/Jimmy110101013/fly-megacode#working-memory-who-is-doing-the-remembering).
