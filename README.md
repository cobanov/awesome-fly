...
- [DesktopFly for Android](https://github.com/lan450/desktop-fly-android) by **lan450** - Java/Android port of DesktopFly running the FlyWire v783 escape/steering brain (668-neuron circuit subset, 1 kHz LIF) and the full MaleCNS leg locomotor cord live on a phone, with touch-based looming/wind/tap senses, circadian rhythm, thermal tempo scaling the leg clock, and JVM regression suites diffed bit-for-bit against the Swift reference. MIT; data licenses inherited.
